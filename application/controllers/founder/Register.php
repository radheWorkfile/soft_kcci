...
class Register extends CI_Controller {
    ...
    public function manRegister()
    {
        ...
        $data['founData'] = $this->ComModel->showAllDataWcon('*',array('created_by_user_type_id' => $this->session->userdata('user_ids')),'registration');
        // print_r($data['founData']);die;
        $this->load->view('founder/register/manage_register',$data);
    }
    ...
    { $data['founderNver'] = $this->ComModel->disData('*',array('id' => $this->session->userdata('user_ids'),'status' => 0 ),'registration');
        ...
        $this->load->view('founder/register/add_register',$data);
    }
    ...
    public function viewDAta()
    {
        if($this->input->is_ajax_request()) {
            ...
            $this->load->view('founder/register/viewRegis',$data);
        }
