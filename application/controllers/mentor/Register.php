...
class Register extends CI_Controller {
            ...
            public function manRegister()
    {
        ...
        $data['mentorData'] = $this->ComModel->showAllDataWcon('*',array('created_by_user_type_id' => $this->session->userdata('user_ids')),'registration');
        // print_r($data['register']);die;



        $this->load->view('mentor/register/manage_register',$data);
    }
    ...
    public function add_register()
    {
        ...
        $this->load->view('mentor/register/add_register',$data);
    }
    ...
    public function editRegData()
    {
        ...
        $this->load->view('mentor/register/editRegData',$data);
    }
