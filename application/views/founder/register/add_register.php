...
<body>
    ...
    <script>
        ...
        $("#addData").on("submit", function(e) {
            ...
            $.ajax({
                type: "post",
                url:base_url+"founder/Register/saveData",
        ...
        function get_subCaste(caste) {
            $.ajax({
                url: '<?= base_url() ?>founder/Register/get_sub_caste',
                type: "POST",
                data: {
                    'caste': caste
                },
        ...
        function getDistric(state) {
            $.ajax({
                url: '<?= base_url() ?>founder/Register/get_distric',
                type: "POST",
                data: {
                    'state': state
                },
...
// ---------------------------------------------------------- 
        ...
        function getpPolice(distric) {
            $.ajax({
                url: '<?= base_url() ?>founder/Register/get_police',
                type: "POST",
                data: {
                    'distric': distric
                },
            ...
            $.ajax({
                url: '<?= base_url() ?>founder/Register/get_post',
                type: "POST",
                data: {
                    'distric': distric
                },
            ...
            $.ajax({
                url: '<?= base_url() ?>founder/Register/get_block',
                type: "POST",
                data: {
                    'distric': distric
                },
        ...
        function getIndustries(sector) {
            ...
            $.ajax({
                url: '<?= base_url() ?>founder/Register/get_business_type',
                type: "POST",
                data: {
                    'sector': sector
                },
            ...
            $.ajax({
                url: '<?= base_url() ?>founder/Register/get_industries',
                type: "POST",
                data: {
                    'sector': sector
                },
