...
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="apiCallbacks" class="table custom-table dataTable no-footer" aria-describedby="apiCallbacks_info">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($founData as $re => $ten) { ?>
                                                            <tr>
    ...
    <script>
        $("#addFouData").on("submit", function(e) {
            ...
            $.ajax({
                type: "post",
                url: '<?= base_url() ?>founder/Tender/addDAta',
        ...
        $("#updatelData").on("submit", function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '<?= base_url() ?>founder/Register/updateData',
                type: "post",
                data: new FormData(this),
                processData: false,
                contentType: false,
        ...
        function viewDatafun(id) {
            ...
            $.ajax({
                type: "POST",
                url: '<?= base_url() ?>' + 'founder/Register/viewDAta',
                data: {
                    'id': id
                },
                success: function(data) {
        ...
        function deleteDAta(id) {
            ...
            $.ajax({
                type: "POST",
                url: '<?= base_url() ?>' + 'founder/Register/deleteData',
                data: {
                    'id': id
                },
                success: function(data) {
