...
<body>
    ...
    <div class="content-wrapper-scroll">
        ...
        <!-- --------------------------- 1st sectioin start ---------------------- -->
        <div class="card">
            <form action="" id="updateFile" method="post">
            ...
            <div class="input-group">
            <span class="input-group-text"><i class="bi bi-link-45deg"></i></span>
            <input type="email" id="mail" name="mail" value="<?php echo $regist['mail'] ?>" class="form-control" placeholder="Enter Valid Email Id *">
            </div>
            </div>
            </div>
            <!------------------------------ contact section end --------------------------->
            ...
            <div class="input-group">
            <span class="input-group-text"><i class="bi bi-link-45deg"></i></span>
            <input type="email" class="form-control" value="<?php echo $regist['email'] ?>" name="email" id="email" placeholder="Enter Email Id">
            </div>
            </div>
            </div>
