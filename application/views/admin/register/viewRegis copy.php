...
<div class="row">
  <div class="col-md-6">
    ...
    <p class="borMa"><span class="texcol">Package</span><span  class="float-end texcol"><?php echo $regis['package'];?></span></p>
  </div>
  ...
  <div class="col-md-6">
    ...
    <p class="borMa"><span class="texcol">Photo </span><span  class="float-end texcol"><img src="<?php echo base_url()."uploads/registration/".$regis['photo'];?>" alt=""></span></p>
