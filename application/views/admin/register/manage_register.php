...
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="apiCallbacks" class="table custom-table dataTable no-footer" aria-describedby="apiCallbacks_info">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($register as $re => $ten) { ?>
                                                            <tr>
    ...
    $("#AddChild").on("click",function(){
        $("#miAddNoChild").append('<div class="col-md-6"><div class="card-body"><label for="">Enter Child Name*</label><div class="input-group"><span class="input-group-text"><i class="bi bi-link-45deg"></i></span><input type="text" name="child_name1" id="child_name1" class="form-control" placeholder="Enter Child Name "></div></div></div>');  
    });
